...
{
    public class DCSA1304Controller : Controller
    {
        // GET: DCSA1304
        public ActionResult Index()
        {
            ...
            List<tbl_DCSA1304_mark1> DCSA1304 = db.tbl_DCSA1304_mark1.Where(s => s.tbl_student.st_semester1 == true && s.st_center_code == st).ToList();
            return View(DCSA1304.ToList());
        }

        [HttpPost]
        public ActionResult UpdateCustomer(tbl_DCSA1304_mark1 customer)
        {
            using (DcsaContext db = new DcsaContext())
            {
                tbl_DCSA1304_mark1 updatedCustomer = (from c in db.tbl_DCSA1304_mark1
