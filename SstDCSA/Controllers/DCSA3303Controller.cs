...
{
    public class DCSA3303Controller : Controller
    {
        // GET: DCSA3303
        public ActionResult Index()
        {
            ...
            List<tbl_DCSA3303_mark3> DCSA3303 = db.tbl_DCSA3303_mark3.Where(s => s.tbl_student.st_semester3 == true && s.st_center_code == st).ToList();
            return View(DCSA3303.ToList());
        }

        [HttpPost]
        public ActionResult UpdateCustomer(tbl_DCSA3303_mark3 customer)
        {
            using (DcsaContext db = new DcsaContext())
            {
                tbl_DCSA3303_mark3 updatedCustomer = (from c in db.tbl_DCSA3303_mark3
