...
{
    public class DCSA1302Controller : Controller
    {
        // GET: DCSA1302
        public ActionResult Index()
        {
            ...
            List<tbl_DCSA1302_mark1> DCSA1302 = db.tbl_DCSA1302_mark1.Where(s => s.tbl_student.st_semester1 == true && s.st_center_code == st).ToList();
            return View(DCSA1302.ToList());
        }

        [HttpPost]
        public ActionResult UpdateCustomer(tbl_DCSA1302_mark1 customer)
        {
            using (DcsaContext db = new DcsaContext())
            {
                tbl_DCSA1302_mark1 updatedCustomer = (from c in db.tbl_DCSA1302_mark1
