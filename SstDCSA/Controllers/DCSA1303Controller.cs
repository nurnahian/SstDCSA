...
{
    public class DCSA1303Controller : Controller
    {
        // GET: DCSA1303
        public ActionResult Index()
        {
            ...
            List<tbl_DCSA1303_mark1> DCSA1303 = db.tbl_DCSA1303_mark1.Where(s => s.tbl_student.st_semester1 == true && s.st_center_code == st).ToList();
            return View(DCSA1303.ToList());
        }

        [HttpPost]
        public ActionResult UpdateCustomer(tbl_DCSA1303_mark1 customer)
        {
            using (DcsaContext db = new DcsaContext())
            {
                tbl_DCSA1303_mark1 updatedCustomer = (from c in db.tbl_DCSA1303_mark1
