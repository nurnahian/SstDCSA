...
{
    public class DCSA2302Controller : Controller
    {
        // GET: DCSA2302
        public ActionResult Index()
        {
            ...
            List<tbl_DCSA2302_mark2> DCSA2302 = db.tbl_DCSA2302_mark2.Where(s => s.tbl_student.st_semester2 == true && s.st_center_code == st).ToList();
            return View(DCSA2302.ToList());
        }

        [HttpPost]
        public ActionResult UpdateCustomer(tbl_DCSA2302_mark2 customer)
        {
            using (DcsaContext db = new DcsaContext())
            {
                tbl_DCSA2302_mark2 updatedCustomer = (from c in db.tbl_DCSA2302_mark2
